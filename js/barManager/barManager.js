...
barManager.prototype.create = function create() {
  ...
  //////////////////PROGRESS BAR SHIELD////////////////////
  /////////////////////////////////////////////////////////
  this.shield = this.game.add.sprite(100, 0, 'progressBarShield');
  this.shield.animations.add('progressBar0', [9], 10, true);
  this.shield.animations.add('progressBar10', [9], 10, true);
  this.shield.animations.add('progressBar20', [8], 10, true);
  this.shield.animations.add('progressBar30', [7], 10, true);
  this.shield.animations.add('progressBar40', [6], 10, true);
  this.shield.animations.add('progressBar50', [5], 10, true);
  this.shield.animations.add('progressBar60', [4], 10, true);
  this.shield.animations.add('progressBar70', [3], 10, true);
  this.shield.animations.add('progressBar80', [2], 10, true);
  this.shield.animations.add('progressBar90', [1], 10, true);
  this.shield.animations.add('progressBar100', [0], 10, true);

  //////////////////////////////////////////////////////////
  //////////////////PROGRESS BAR PASSENGER//////////////////
  /////////////////////////////////////////////////////////
  this.passenger = this.game.add.sprite(200, 0, 'progressBarPassenger');
  this.passenger.animations.add('progressBar0', [9], 10, true);
  this.passenger.animations.add('progressBar10', [9], 10, true);
  this.passenger.animations.add('progressBar20', [8], 10, true);
  this.passenger.animations.add('progressBar30', [7], 10, true);
  this.passenger.animations.add('progressBar40', [6], 10, true);
  this.passenger.animations.add('progressBar50', [5], 10, true);
  this.passenger.animations.add('progressBar60', [4], 10, true);
  this.passenger.animations.add('progressBar70', [3], 10, true);
  this.passenger.animations.add('progressBar80', [2], 10, true);
  this.passenger.animations.add('progressBar90', [1], 10, true);
  this.passenger.animations.add('progressBar100', [0], 10, true);

  //////////////////////////////////////////////////////////
  //////////////////PROGRESS BAR search//////////////////
  /////////////////////////////////////////////////////////
  this.search = this.game.add.sprite(300, 0, 'progressBarSearch');
