...
gameOver.prototype = {
      ...
      {
         text = game.add.text(50, 400,"You manage to gather " + this.game.totalPassenger + " people but you forgot to pay attention to your fuel gauge... You ran out of fuel in the vicinity of a gravitational singularity... The passengers are looking at you in a funny way... I wonder how you will die...", style);
      }else if(this.game.totalShield<=0) {
        text = game.add.text(50, 400,"You gathered " + this.game.totalPassenger + " people to help you in your quest, and you managed to go this far. But you forgot that space is an unforgivable place... Your shield was completely depleted when a speedy teeny tiny flying rock came to say hello, it went through your hull like it was a sheet of paper and torn it apart. In a blink of an eye, you and your passengers ended up floating in space...", style);
      }
